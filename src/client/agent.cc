	...
	hsa_status_t hsa_agent_get_info(hsa_agent_t agent, hsa_agent_info_t attribute, void *value) {
		...
		switch(attribute) {
			...
			case HSA_AGENT_INFO_FEATURE: {
				*((hsa_agent_feature_t *)value) = (hsa_agent_feature_t)currentAgent->GetFeature(); 
				break;
			}
			case HSA_AGENT_INFO_MACHINE_MODEL: {
				*((hsa_machine_model_t *)value) = (hsa_machine_model_t)currentAgent->GetFeature(); 
				break;
			}
			...
			case HSA_AGENT_INFO_DEFAULT_FLOAT_ROUNDING_MODE: {
				*((hsa_default_float_rounding_mode_t *)value) = (hsa_default_float_rounding_mode_t)currentAgent->GetDefaultFloatRoundingMode();
				break;
			}
			...
			case HSA_AGENT_INFO_QUEUE_TYPE: {
				*((hsa_queue_type_t *)value) = (hsa_queue_type_t)currentAgent->GetQueueType(); 
				break;
			}
			...
			case HSA_AGENT_INFO_DEVICE: {
				*((hsa_device_type_t *)value) = (hsa_device_type_t)currentAgent->GetDeviceType();
				break;
			}
